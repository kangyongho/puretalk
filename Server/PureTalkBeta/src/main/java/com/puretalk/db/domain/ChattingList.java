...
public class ChattingList {
	...
	public ChattingList(String usercellphone, String friendname, String friendcellphone, int flag) {
		super();
	...
	public ChattingList(String usercellphone, String friendname, String friendcellphone, int flag, String gcmid) {
		super();
		this.usercellphone = usercellphone;
		this.friendname = friendname;
		this.friendcellphone = friendcellphone;
